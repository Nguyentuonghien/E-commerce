...
public class CountryRestControllerTests {
	...
	public void testListCountries() throws Exception {
		String url = "/countries/list";  // url bên phía restcontroller
	...
	public void testCreateCountry() throws JsonProcessingException, Exception {
		...
		MvcResult result = mockMvc.perform(post(url).contentType("application/json")
				                  .content(objectMapper.writeValueAsString(country))   // write java object Country to JSON String
				                  .with(csrf()))     // pass value of csrf token
