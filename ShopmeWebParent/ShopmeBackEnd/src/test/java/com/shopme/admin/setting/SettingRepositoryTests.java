...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		...
		List<Setting> savedSetting = Arrays.asList(siteLogo, copyright);
		settingRepository.saveAll(savedSetting);
	...
	public void testCreateCurrencySettings() {
		...
		List<Setting> listSettings = Arrays.asList(currencyId, symbol, symbolPosition, decimalPointType, decimalDigits, thousandsPointType);
